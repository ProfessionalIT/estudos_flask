...
def index():
    ...
    return render_template('index.html', noticias=todas_as_noticias,
...
def cadastro():
    ...
    return render_template('cadastro.html', title=u'Inserir nova notícia')
...
if __name__ == "__main__":
    app.run(debug=True, use_reloader=True, port=4001)
